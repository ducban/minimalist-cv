...
export const RESUME_DATA: ResumeData = {
  ...
  projects: [
    {
      title: "Train Ticket Booking Refactoring",
      techStack: ["Backend Refactor", "UX Redesign", "A/B Testing", "Cross-functional Coordination"],
      description:
        "Delivered 1.5 percentage point conversion rate increase in Train ticket booking through comprehensive backend refactor, UX redesign, and cross-functional coordination. Defined tracking metrics, implemented A/B testing for funnel optimization, and collaborated with Front-end Developers, QC Engineers, and Data Analysts. Increased E2E CR by 1.5 percentage points within two weeks, maintaining 2.2pp year-over-year growth.",
      link: {
    ...
    },
    {
      ...
      techStack: ["Rule-based Trigger Missions", "Campaign Management", "Partnership Integration"],
      description:
        "Led co-branding campaign with Vietnam Airlines, winning Human Act Prize 2024 for Sustainable Development Ideas. Generated 35,000 trees planted across 50 hectares through rule-based trigger missions with charity gesture embedded into each ticket sold. Traditional campaign management demonstrating product fundamentals.",
      link: {
    ...
    },
    {
      ...
      description:
        "Launched Vietnam's first integrated C2C marketplace within main e-commerce app, achieving 40% CVR discovery to PDP, 5% CVR to successful orders, and 20% daily active user retention. Led hands-on development of foundational Order Management System (OMS) and Customer Relationship Management (CRM) systems from scratch.",
      link: {
    ...
    },
    {
      ...
      description:
        "Built comprehensive monitoring system using Puppeteer crawlers to track competitor websites and campaigns, providing real-time market intelligence and strategic insights for travel industry operations. Implemented n8n workflows for automated competitor observation and strategic decision-making support.",
      link: {
    ...
    },
    {
      ...
      description:
        "Developed RAG-based Chat agent system that significantly improved cross-team collaboration by providing instant access to institutional knowledge and reducing information silos. Built system to minimize cross-team meetings for information inquiry, leveraging cross-functional artifacts to generate BRD, PRD, and other documents. Reduced meeting times by 30%.",
      link: {
        label: "Internal Project",
        href: "https://momo.vn/",
      },
    ...
    {
      title: "Maps-Based Web Application",
      techStack: ["Google Maps API", "Web Development", "Location-based Services"],
      description:
        "Personal passion project, angi.truanay.com, demonstrating interest in location-based technology. Developed Google Maps-based web application allowing users to explore well-curated lunch options in their neighborhoods. Created intuitive interface for discovering local restaurants with curated recommendations and location-based search functionality. Successfully launched and operated for two years (2022-2024).",
      link: {
        label: "Personal Project",
        href: "https://angi.truanay.com",
      },
    },
  ],
} as const;
